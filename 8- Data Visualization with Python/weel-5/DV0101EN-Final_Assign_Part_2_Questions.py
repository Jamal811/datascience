...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            figure=px.bar(
                ...
                x='Vehicle_Type',
                y='Automobile_Sales',
                title="Average number of vehicles sold by vehicle type during a recession"
            )
        )
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemployment_vs_vehicle = recession_data.groupby('Vehicle_Type')['Price'].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(
                unemployment_vs_vehicle,
                x='Vehicle_Type',
                y='Price',
